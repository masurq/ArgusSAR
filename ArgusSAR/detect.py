...
def run(
    weights=ROOT / "runs/train/SSDD/m_hyphigh/weights/best.pt",  # model path or triton URL
    source=ROOT / "data/SSDD/images/test",  # file/dir/URL/glob/screen/0(webcam)
    data=ROOT / "data/SSDD.yaml",  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/SSDD/m_hyphigh/weights/best.pt", help="model path or triton URL")
    parser.add_argument("--source", type=str, default=ROOT / "data/SSDD/images/test", help="file/dir/URL/glob/screen/0(webcam)")
