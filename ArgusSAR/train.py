...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "weights/weight.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=ROOT / "models/ArgusSAR.yaml", help="model.yaml path")
